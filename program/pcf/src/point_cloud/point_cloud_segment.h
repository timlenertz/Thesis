...
Interval of points in a point cloud. Does not own the memory. Also used as base class for
the point cloud itself. Provides operations that reorder points, but none that are relevant
only for a whole model. (such as applying a transformation).
*/
