...
set_target_properties(opencv_ml PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ml249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_ml249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ml )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ml "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ml249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_ml249d.dll" )
...
set_target_properties(opencv_video PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_video249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_video249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_video )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_video "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_video249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_video249d.dll" )
...
set_target_properties(opencv_legacy PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_legacy249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_legacy249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_legacy )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_legacy "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_legacy249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_legacy249d.dll" )
...
set_target_properties(opencv_objdetect PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_objdetect249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc;opencv_highgui"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_objdetect249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_objdetect )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_objdetect "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_objdetect249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_objdetect249d.dll" )
...
set_target_properties(opencv_photo PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_photo249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_imgproc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_photo249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_photo )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_photo "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_photo249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_photo249d.dll" )
...
set_target_properties(opencv_gpu PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_gpu249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_gpu249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_gpu )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_gpu "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_gpu249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_gpu249d.dll" )
...
set_target_properties(opencv_ocl PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ocl249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_ocl249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ocl )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ocl "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ocl249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_ocl249d.dll" )
...
set_target_properties(opencv_nonfree PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_nonfree249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_nonfree249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_nonfree )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_nonfree "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_nonfree249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_nonfree249d.dll" )
...
set_target_properties(opencv_contrib PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_contrib249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_contrib249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_contrib )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_contrib "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_contrib249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_contrib249d.dll" )
...
set_target_properties(opencv_stitching PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_stitching249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_flann;opencv_imgproc;opencv_highgui;opencv_features2d;opencv_calib3d;opencv_ml;opencv_video;opencv_legacy;opencv_objdetect;opencv_photo;opencv_gpu;opencv_ocl;opencv_nonfree"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_stitching249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_stitching )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_stitching "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_stitching249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_stitching249d.dll" )
...
set_target_properties(opencv_superres PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_superres249d.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_flann;opencv_imgproc;opencv_highgui;opencv_features2d;opencv_calib3d;opencv_ml;opencv_video;opencv_legacy;opencv_objdetect;opencv_photo;opencv_gpu;opencv_ocl"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_superres249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_superres )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_superres "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_superres249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_superres249d.dll" )
...
set_target_properties(opencv_ts PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "opencv_core;opencv_flann;opencv_imgproc;opencv_highgui;opencv_features2d"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ts249d.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ts )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ts "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_ts249d.lib" )
...
set_target_properties(opencv_videostab PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_videostab249d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_videostab249d.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_videostab )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_videostab "${_IMPORT_PREFIX}/x64/vc11/lib/opencv_videostab249d.lib" "${_IMPORT_PREFIX}/x64/vc11/bin/opencv_videostab249d.dll" )
